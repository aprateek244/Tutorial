            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtSiteName" placeholder="Email">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="txtIcon" placeholder="Password">
                  </div>
                </div>
                 <div class="form-group">
              ...
              <div class="box-footer">
                ...
                <input type="button" class="btn btn-info pull-right">Sign in
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
